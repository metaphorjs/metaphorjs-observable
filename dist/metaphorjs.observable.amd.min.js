'use strict';define("metaphorjs-observable",function(){function n(c){return"object"==typeof c&&3===r(c)&&!c.nodeType&&c.constructor===Object}function p(c){return!0===c||!1===c}var s=Function.prototype.bind?function(c,a){return c.bind(a)}:function(c,a){return function(){return c.apply(a,arguments)}},l=Array.prototype.slice,t=Object.prototype.toString,r=function(){var c={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,
"[object Date]":10};return function(a){if(!a){if(null===a)return 6;if(void 0===a)return 7}var b=c[t.call(a)];return void 0===b?-1:1==b&&isNaN(a)?8:b}}(),m=function(){return function a(){var b=!1,d=!1,f=l.call(arguments),e=f.shift(),k,g,h;p(f[f.length-1])&&(b=f.pop());p(f[f.length-1])&&(d=b,b=f.pop());for(;f.length;)if(k=f.shift())for(g in k)if(k.hasOwnProperty(g)&&void 0!==(h=k[g]))if(d)if(e[g]&&n(e[g])&&n(h))a(e[g],h,b,d);else{if(!0===b||void 0==e[g])n(h)?(e[g]={},a(e[g],h,b,!0)):e[g]=h}else if(!0===
b||void 0==e[g])e[g]=h;return e}}(),u=function(){var c=["0","0","0"];return function(){for(var a=c.length,b;a;){a--;b=c[a].charCodeAt(0);if(57==b)return c[a]="A",c.join("");if(90==b)c[a]="0";else return c[a]=String.fromCharCode(b+1),c.join("")}c.unshift("0");return c.join("")}}(),q=function(){var c=function(a,b,d,f,e){this.name=a;this.listeners=[];this.map={};this.hash=u();this.uni="$$"+a+"_"+this.hash;this.suspended=!1;this.lid=0;"object"==typeof b&&null!==b?m(this,b,!0,!1):(this.returnResult=void 0===
b?null:b,this.autoTrigger=d,this.triggerFilter=f,this.filterContext=e)};m(c.prototype,{name:null,listeners:null,map:null,hash:null,uni:null,suspended:!1,lid:null,returnResult:null,autoTrigger:null,lastTrigger:null,triggerFilter:null,filterContext:null,getName:function(){return this.name},destroy:function(){for(var a in this)this[a]=null},on:function(a,b,d){if(!a)return null;b=b||null;d=d||{};var f=this.uni,e=b||a;if(e[f]&&!d.allowDupes)return null;var c=++this.lid,g=d.first||!1;e[f]=c;a={fn:a,context:b,
uniContext:e,id:c,called:0,limit:0,start:1,count:0,append:null,prepend:null};m(a,d,!0,!1);g?this.listeners.unshift(a):this.listeners.push(a);this.map[c]=a;if(this.autoTrigger&&this.lastTrigger&&!this.suspended){var h=this.triggerFilter;this.triggerFilter=function(a){return a.id==c?h?!1!==h(a):!0:!1};this.trigger.apply(this,this.lastTrigger);this.triggerFilter=h}return c},once:function(a,b,d){d=d||{};d.limit=1;return this.on(a,b,d)},un:function(a,b){var d=-1,f=this.uni,e=this.listeners,c;c=a==parseInt(a)?
a:(b||a)[f];if(!c)return!1;for(var g=0,h=e.length;g<h;g++)if(e[g].id==c){d=g;delete e[g].uniContext[f];break}if(-1==d)return!1;e.splice(d,1);delete this.map[c];return!0},hasListener:function(a,b){var d=this.listeners,f;if(a){f="function"!=typeof a?a:(b||a)[this.uni];if(!f)return!1;for(var e=0,c=d.length;e<c;e++)if(d[e].id==f)return!0;return!1}return 0<d.length},removeAllListeners:function(){var a=this.listeners,b=this.uni,d,f;d=0;for(f=a.length;d<f;d++)delete a[d].uniContext[b];this.listeners=[];
