define("metaphorjs-observable",function(){function r(a){return"object"==typeof a&&3===w(a)&&!a.nodeType&&a.constructor===Object}function u(a){return!0===a||!1===a}function x(a,b,c,d){return setTimeout(function(){a.apply(b,c||[])},d||0)}var y=Function.prototype.bind?function(a,b){return a.bind(b)}:function(a,b){return function(){return a.apply(b,arguments)}},p=Array.prototype.slice,z=Object.prototype.toString,w=function(){var a={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,
"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(b){if(!b){if(null===b)return 6;if(void 0===b)return 7}var c=a[z.call(b)];return void 0===c?-1:1===c&&isNaN(b)?8:c}}(),q=function(){return function b(){var c=!1,d=!1,e=p.call(arguments),f=e.shift(),m,g,l;u(e[e.length-1])&&(c=e.pop());u(e[e.length-1])&&(d=c,c=e.pop());for(;e.length;)if((m=e.shift())&&m.hasOwnProperty)for(g in m)if(m.hasOwnProperty(g)&&void 0!==(l=m[g]))if(d)if(f[g]&&r(f[g])&&r(l))b(f[g],
l,c,d);else{if(!0===c||void 0==f[g])r(l)?(f[g]={},b(f[g],l,c,!0)):f[g]=l}else if(!0===c||void 0==f[g])f[g]=l;return f}}(),A=function(){var a=["0","0","0"];return function(){for(var b=a.length,c;b;){b--;c=a[b].charCodeAt(0);if(57==c)return a[b]="A",a.join("");if(90==c)a[b]="0";else return a[b]=String.fromCharCode(c+1),a.join("")}a.unshift("0");return a.join("")}}(),t=function(a,b){this.name=a;this.listeners=[];this.map={};this.hash=A();this.uni="$$"+a+"_"+this.hash;this.suspended=!1;this.lid=0;"object"===
typeof b&&null!==b?q(this,b,!0,!1):this.returnResult=b};q(t.prototype,{name:null,listeners:null,map:null,hash:null,uni:null,suspended:!1,lid:null,returnResult:null,autoTrigger:null,lastTrigger:null,triggerFilter:null,filterContext:null,expectPromises:!1,resolvePromises:!1,getName:function(){return this.name},$destroy:function(){for(var a in this)this[a]=null},on:function(a,b,c){if(!a)return null;b=b||null;c=c||{};var d=this.uni,e=a[d]||++this.lid,f=d+"_"+e,m=c.first||!1;if(a[d]&&(!b||b[f])&&!c.allowDupes)return null;
