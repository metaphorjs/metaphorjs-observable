'use strict';(function(){function m(a){return"object"==typeof a&&3===t(a)&&!a.nodeType&&a.constructor===Object}function q(a){return!0===a||!1===a}var n={lib:{},cmp:{},view:{}},u=function(){var a=["0","0","0"];return function(){for(var b=a.length,c;b;){b--;c=a[b].charCodeAt(0);if(57==c)return a[b]="A",a.join("");if(90==c)a[b]="0";else return a[b]=String.fromCharCode(c+1),a.join("")}a.unshift("0");return a.join("")}}(),v=Function.prototype.bind?function(a,b){return a.bind(b)}:function(a,b){return function(){return a.apply(b,
arguments)}},l=Array.prototype.slice,w=Object.prototype.toString,t=function(){var a={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(b){if(!b){if(null===b)return 6;if(void 0===b)return 7}var c=a[w.call(b)];return void 0===c?-1:1==c&&isNaN(b)?8:c}}(),r=function(){return function b(){var c=!1,d=!1,e=l.call(arguments),f=e.shift(),h,g,k;q(e[e.length-1])&&(c=e.pop());q(e[e.length-
1])&&(d=c,c=e.pop());for(;e.length;)if(h=e.shift())for(g in h)if(h.hasOwnProperty(g)&&void 0!==(k=h[g]))if(d)if(f[g]&&m(f[g])&&m(k))b(f[g],k,c,d);else{if(!0===c||void 0==f[g])m(k)?(f[g]={},b(f[g],k,c,!0)):f[g]=k}else if(!0===c||void 0==f[g])f[g]=k;return f}}(),s=function(){this.events={}};r(s.prototype,{createEvent:function(a,b){a=a.toLowerCase();var c=this.events;c[a]||(c[a]=new p(a,b));return c[a]},getEvent:function(a){a=a.toLowerCase();return this.events[a]},on:function(a,b,c,d){a=a.toLowerCase();
